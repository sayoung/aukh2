            ...
            <div class="widget gsc-icon-box-new <?php if(count($class)>0) print implode(' ',$class) ?>" <?php if(count($css) > 0) print 'style="'.implode(';',$css).'"' ?> <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>>
               <?php if($icon || $image){ ?>
                  <div class="icon-inner">
                     <?php if($link){ ?><a href="<?php print t($link) ?>"> <?php } ?>
                        <?php if($icon){ ?><span class="icon <?php print t($icon) ?>"></span> <?php } ?>
                        <?php if($image){ ?><span class="icon"><img src="<?php print t($image) ?>" alt="<?php print strip_tags($title) ?>"/> </span> <?php } ?>
                     <?php if($link){ ?> </a> <?php } ?>
                  </div>
               <?php } ?>
               <div class="content-inner">
                  <div class="title"><?php print t($title); ?></div>
                  <?php if($content){ ?><div class="desc <?php print $hidden_content ?>"><?php print t($content); ?></div><?php } ?>   
               </div>
            </div> 
         <?php } ?>
