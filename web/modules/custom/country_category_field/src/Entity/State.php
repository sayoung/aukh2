 ...
 *     "list_builder" = "Drupal\country_category_field\StateListBuilder",
 *     "views_data" = "Drupal\country_category_field\Entity\StateViewsData",
 *     "translation" = "Drupal\country_category_field\StateTranslationHandler",
 *
 *     "form" = {
 *       "default" = "Drupal\country_category_field\Form\StateForm",
 *       "add" = "Drupal\country_category_field\Form\StateForm",
 *       "edit" = "Drupal\country_category_field\Form\StateForm",
 *       "delete" = "Drupal\country_category_field\Form\StateDeleteForm",
 *     },
 *     "access" = "Drupal\country_category_field\StateAccessControlHandler",
 *     "route_provider" = {
 *       "html" = "Drupal\country_category_field\StateHtmlRouteProvider",
 *     },
 *   },
 *   base_table = "state",
