<?php
function gavias_castron_render_block($key) {  
...
function gavias_castron_makeid($length = 5){
...
function gavias_castron_base_url(){
  global $base_url;
  $theme_path = drupal_get_path('theme', 'gavias_castron');
  return $base_url . '/' . $theme_path . '/';
}

function gavias_castron_preprocess_node(&$variables) {
...
function gavias_castron_preprocess_node__portfolio(&$variables){
  $node = $variables['node'];
...
function gavias_castron_preprocess_node__event(&$variables){
  $node = $variables['node'];
  $event_date = array();
...
function gavias_castron_preprocess_breadcrumb(&$variables){
