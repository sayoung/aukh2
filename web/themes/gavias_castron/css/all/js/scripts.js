(function($){
	...
	$(document).ready( function(){
		...
		$.backstretch('https://aust.ma/themes/gavias_castron/css/all/images/bg1.jpg');
		...
		$('#modal-open').on('click', function(e) {
			var main0Inner = $('#main0 .inner'),
				modal = $('#modal');

			main0Inner.animate({ opacity: 0 }, 400, function(){
			...
			$('#modal-close').on('click', function(e) {
				modal.removeClass('modal-active').fadeOut(400, function(){
					main0Inner.animate({ opacity: 1 }, 400);
				});
				e.preventDefault();
			});
		});
