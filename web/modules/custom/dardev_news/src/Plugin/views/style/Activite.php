 ...
 * @ViewsStyle(
 *   id = "views_activite",
 *   title = @Translation("AUNADOR Latest Activite"),
 *   help = @Translation("Displays rows in a views Latest Activite"),
 *   theme = "views_activite",
 *   theme_file = "/../views_news.theme.inc",
 *   display_types = {"normal"}
 * )
 */
class Activite extends StylePluginBase {
  /**
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    if (isset($form['grouping'])) {
      ...
      $form['ar_created_field'] = [
        '#type' => 'select',
        '#title' => $this->t('ar de creation field'),
        '#options' => $this->displayHandler->getFieldLabels(TRUE),
        '#required' => TRUE,
        '#default_value' => $this->options['ar_created_field'],
        '#description' => $this->t('Select the field that will be used for the created date.'),
      ];
    }
  }
