            ...
            <div class="owl-carousel init-carousel-owl owl-loaded owl-drag f01" data-items="6" data-items_lg="6" data-items_md="5" data-items_sm="4" data-items_xs="2" data-loop="1" data-speed="500" data-auto_play="1" data-auto_play_speed="2000" data-auto_play_timeout="5000" data-auto_play_hover="1" data-navigation="1" data-rewind_nav="0" data-pagination="0" data-mouse_drag="1" data-touch_drag="1">
               <?php for($i=1; $i<=10; $i++){ ?>
                  ...
                  <?php if($$title){ ?>
                     ...
                     <?php if($$title){ ?><div class="title"><a href="<?php print t($$link) ?>"><?php print t($$title) ?></a></div><?php } ?>
                     </div></div>
                  <?php } ?>    
               <?php } ?>
            </div> 
            <?php if($more_link){ ?>
               <div class="read-more"><a class="btn-theme" href="<?php print $more_link ?>"><?php print t($more_text) ?></a></div>
            <?php } ?>   
         </div>   
